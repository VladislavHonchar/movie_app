...
class NotifierProvider<Model extends ChangeNotifier> extends StatefulWidget {
  ...
  const NotifierProvider({super.key,this.isManagingModel = true, required this.create, required this.child});
  ...
  static Model? read<Model extends ChangeNotifier>(BuildContext context) {
    final widget = context.getElementForInheritedWidgetOfExactType<_InheritedNotifierProvider<Model>>()?.widget;
...
class _InheritedNotifierProvider<Model extends ChangeNotifier> extends InheritedNotifier {
  final Model model;
  const _InheritedNotifierProvider({super.key,required this.model, required this.child}) : super(notifier: model, child: child);
...
class Provider<Model> extends InheritedWidget {
  final Model model;
  const Provider({super.key,required this.model, required this.child}) : super(child: child);
